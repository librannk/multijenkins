using CCEProxy.API.Infrastructure.DataAccess.Mongo.Constants;
using MongoDB.Driver;
using System;

namespace CCEProxy.API.Infrastructure.DataAccess.Mongo.Clients
{
    /// <summary>
    ...
    public class MongoDbClient
    {
        ...
        {
            if (Client == null) throw new NullReferenceException(ErrorConstants.ClientNotInstantiated);
