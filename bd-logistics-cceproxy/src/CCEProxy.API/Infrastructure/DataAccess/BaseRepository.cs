...
namespace CCEProxy.API.Infrastructure.DataAccess
{
    /// <summary>
    /// Base repository for CRUD operations
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public abstract class BaseRepository<T> : IBaseRepository<T> where T : CCEProxy.API.Infrastructure.DataAccess.Mongo.Entities.Entity
    {
        /// <summary>
        /// Context variable
        /// </summary>
        ...
        public BaseRepository(ElasticDbContext dataContext)
        {
