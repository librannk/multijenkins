...
{
    public class FacilityItemRepository : BaseRepository<FacilityItemEntity>, IFacilityItemRepository
    {
        public FacilityItemRepository(ApplicationDBContext context) : base(context)
        {
