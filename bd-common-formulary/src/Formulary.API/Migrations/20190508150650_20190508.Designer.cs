...
namespace Formulary.API.Migrations
{
    ...
    [Migration("20190508150650_20190508")]
    partial class _20190508
    {
            ...
            modelBuilder.Entity("Formulary.API.Infrastructure.DataAccess.SQL.DBContextEntities.Entities.ItemEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("EndUTCTime")
                        .HasColumnType("DateTimeOffset(7)");
                    ...
                    b.Property<DateTimeOffset?>("StartUTCDateTime")
                        .IsRequired()
                        .HasColumnType("DateTimeOffset(7)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedDateTime = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedUTCDateTime = new DateTimeOffset(new DateTime(2019, 5, 8, 20, 36, 49, 280, DateTimeKind.Unspecified).AddTicks(434), new TimeSpan(0, 5, 30, 0, 0)),
                            MedicationItemFlag = true,
                            StartUTCDateTime = new DateTimeOffset(new DateTime(2019, 5, 8, 20, 36, 49, 272, DateTimeKind.Unspecified).AddTicks(5045), new TimeSpan(0, 5, 30, 0, 0)),
