...
{
    public class CarWhiteTb14702300Test
    {
        #region Field

        private CarWhiteTb14702300 _carousel;
        ...
        {
            _carousel = new CarWhiteTb14702300(controlType: ControllerType.WhiteTB1470_2300, ipAddr: _carouselData.Attribute.IPAddress, carAddr: _carouselData.Attribute.DeviceNumber,
