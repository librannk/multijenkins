...
{
    public class CarWhiteTB1470Test
    {
        #region Field

        private CarWhiteTB1470 _carousel;
        ...
        {
            _carousel = new CarWhiteTB1470(controlType: ControllerType.WhiteTB1470, ipAddr: _carouselData.Attribute.IPAddress, carAddr: _carouselData.Attribute.DeviceNumber,
