...
using BD.Template.API.AutofacModule;
...
namespace Template.API
{
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApiVersionDescriptionProvider provider)
        {
            ...
            app.UseSwagger(c =>
            {
                c.RouteTemplate = "api/{documentName}/template/swagger/swagger.json";
            });
            app
                .UseSwaggerUI(c =>
                {
                    ...
                    {
                        c.SwaggerEndpoint($"/api/{description.GroupName}/template/swagger/swagger.json", "Template API " + description.GroupName.ToUpperInvariant());
                    }
                    c.RoutePrefix = "api/v1/template";
                });
